...
chapter11.1 <- function() {
    message("Figure 11.1 in 'Demographic Forecasting'...")
    message("Respiratory infections, Belize...")
    ...
    cat("\n")
    cat("> ylc <- yourcast(formula=ff, dataobj=chp.11.1, model=\"LC\")\n")
    ylc <- yourcast(formula=ff, dataobj=chp.11.1, model="LC")

...
extension \file{.txt.gz} since there are compressed, by typing:
...
[21] "chp.2.7.3.RData"    "cntry.codes.txt.gz" "csid204500.txt.gz"  "csid204505.txt.gz" 
[25] "csid204510.txt.gz"  "csid204515.txt.gz"  "csid204520.txt.gz"  "csid204525.txt.gz" 
[29] "csid204530.txt.gz"  "csid204535.txt.gz"  "csid204540.txt.gz"  "csid204545.txt.gz" 
[33] "csid204550.txt.gz"  "csid204555.txt.gz"  "csid204560.txt.gz"  "csid204565.txt.gz" 
[37] "csid204570.txt.gz"  "csid204575.txt.gz"  "csid204580.txt.gz"  "proximity.txt.gz"  
\end{verbatim}. 
...
\file{csid204500.txt.gz}. As we can see below, this file contains all the
...
next file in the directory, \file{csid204505.txt.gz}. Below we can see
...
demo. The first is \file{proximity.txt.gz}, a list of proximity scores
for pairs of the geographic units. The second is
\file{cntry.codes.txt.gz}, a list of all the CSID codes for the
...
dta <- yourprep(dpath=paste(.libPaths()[1],"/YourCast/data",sep=""),
                ...
                G.names="cntry.codes.txt.gz", proximity="proximity.txt.gz",
                verbose=TRUE)
\end{verbatim}
